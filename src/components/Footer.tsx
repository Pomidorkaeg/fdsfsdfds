    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300">
              Спортивный портал - это ваш источник новостей, 
              информации о турнирах и соревнованиях.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/events" className="text-gray-300 hover:text-white">Турниры</Link></li>
              <li><Link to="/teams" className="text-gray-300 hover:text-white">Команды</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="mailto:info@sportportal.ru" className="text-gray-300 hover:text-white">info@sportportal.ru</a></li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-700 text-center">
          <p className="text-gray-400">&copy; {new Date().getFullYear()} Спортивный портал. Все права защищены.</p>
        </div>
      </div>
    </footer>
  );
